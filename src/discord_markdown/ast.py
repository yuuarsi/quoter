...
class DiscordEmoji(Text):
    ...
    def eval(self, markdown=False):
        return f'<{self.HTML_TAG} class="emoji" src="https://cdn.discordapp.com/emojis/{self.value.split(":")[-1][:-1]}.png">'
...
AST_BY_TOKEN_TYPE = {
    ...
    TokenSpecification.DISCORD_EMOJI.name : DiscordEmoji,
}
